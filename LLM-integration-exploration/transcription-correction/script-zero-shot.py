...
from prompts import diarization_prompt_list, punctuation_prompt,  KEYWORD_WHISPER_PROMPT, zero_shot_correction, keywords_audio1, keywords_audio2, all_keywords
import json 
import re 
import os 
import whisper 
...
if __name__=="__main__":
    ...
    def correct(id, segment_text) -> str:
        # correction
        st = datetime.now()
        prompt = zero_shot_correction.format(vocabulary=keywords_audio1, transcript=segment_text)
